...
import { getFirestore, collection, getDocs, onSnapshot, doc, updateDoc, query, orderBy, addDoc } from 'firebase/firestore';
const ProductList = [
  {
    name: "Add",
    description: "Add",
...
function Products() {
  ...
  useEffect(()=>{
     onSnapshot(query(collection(db, "products"), orderBy("position")), (querySnapshot) => {
      setProducts(
            ...
            name === "Add" ? (
              ...
              >
                <Paper
                  ...
                  onClick={() => sendProduct(products.length)}
